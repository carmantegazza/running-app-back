...
const { deleteDocument,changeUserEmail, sendEmail, PreSignIn,SignUp, SignIn , verifyMail, verificarToken,forgotPassword,changePassword } = usersControllers
...
usersRouter.route('/users/auth/forgotpassword/:string').get(changePassword)
